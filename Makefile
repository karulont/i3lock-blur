...
CFLAGS += $(shell $(PKG_CONFIG) --cflags cairo xcb-dpms xcb-xinerama xcb-atom xcb-image xcb-xkb xcb-composite xcb-damage xkbcommon xkbcommon-x11 x11 x11-xcb gl)
LIBS += $(shell $(PKG_CONFIG) --libs cairo xcb-dpms xcb-xinerama xcb-atom xcb-image xcb-xkb xcb-composite xcb-damage xkbcommon xkbcommon-x11 x11 x11-xcb gl)
LIBS += -lpam
LIBS += -lev
LIBS += -lm
